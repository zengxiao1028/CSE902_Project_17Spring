...
def preprocess_train(img):
    ...
    image = tf.image.resize_images(image, [project_config.SD4_INPUT_IMG_SIZE + 20, project_config.SD4_INPUT_IMG_SIZE + 20])
...
if __name__ == '__main__':
    data_generator = DataGenerator(project_config.SD4_DATA_FOLDER)

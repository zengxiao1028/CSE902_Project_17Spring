...
def convert(src_folder, dst_folder):
   ...
   for each in files:
        ...
        #resize
        img = cv2.resize(img, (project_config.SD14_INPUT_IMG_SIZE, project_config.SD14_INPUT_IMG_SIZE), cv2.IMREAD_GRAYSCALE)
...
if __name__ == '__main__':
    ...
    for i in range(8):
        ...
        convert_original_size(scr_folder, project_config.SD4_DATA_ORIGIN_FOLDER)
